...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
		...
		if($(this).children("div").length === 0){
			...
			outerDiv.setAttribute("id",$(this).attr("id") + "-outerDiv");
			...
			canvas.setAttribute("id",$(this).attr("id") + "-canvas");
			...
			percentageText.setAttribute("id",$(this).attr("id") + "-percentageText");
			...
			valueText.setAttribute("id",$(this).attr("id") + "-valueText");
			...
			outerDiv = document.getElementById($(this).attr("id") + "-outerDiv");
			canvas = document.getElementById($(this).attr("id") + "-canvas");
			percentageText = document.getElementById($(this).attr("id") + "-percentageText");
			valueText = document.getElementById($(this).attr("id") + "-valueText");
		}
